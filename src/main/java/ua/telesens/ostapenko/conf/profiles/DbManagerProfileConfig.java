package ua.telesens.ostapenko.conf.profiles;
...
@EnableJpaRepositories(value = {
        "ua.telesens.ostapenko.auth.persistence.repository",
        "ua.telesens.ostapenko.transportmanager.persistence.repository"
})
...
public class DbManagerProfileConfig {
    ...
    @Value("#{environment['auth.entitymanager.packages.to.scan']}")
    private String PROPERTY_AUTH_NAME_ENTITYMANAGER_PACKAGES_TO_SCAN;
    @Value("#{environment['transportmanager.entitymanager.packages.to.scan']}")
    private String PROPERTY_TRANSPORTMANAGER_NAME_ENTITYMANAGER_PACKAGES_TO_SCAN;
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws ClassNotFoundException, URISyntaxException {
        ...
        entityManagerFactoryBean.setPackagesToScan(
                PROPERTY_AUTH_NAME_ENTITYMANAGER_PACKAGES_TO_SCAN,
                PROPERTY_TRANSPORTMANAGER_NAME_ENTITYMANAGER_PACKAGES_TO_SCAN
